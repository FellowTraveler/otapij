...
public class OTAPI_Func {
    ...
    public String   strData, strData2, strData3, strData4, strData5;
   ...
   public OTAPI_Func(FT theType,
           ...
           boolean bSelling, String strLifespanInSeconds) { // 13 args
       ...
       if (!Utility.VerifyStringVal(strLifespanInSeconds))
           strLifespanInSeconds = new String("86400"); // 86400 seconds == 1 day.
        ...
        this.strData4   = price;
        this.strData5   = strLifespanInSeconds;
        ...
        switch (this.funcType) {
            ...
            case CREATE_MARKET_OFFER:
                nRetVal = otapiJNI.OTAPI_Basic_issueMarketOffer(this.serverID, this.nymID, this.accountID, this.accountID2,
                        this.strData, this.strData2, this.strData3, this.strData4, this.bBool, this.strData5);
                break;
            default:
