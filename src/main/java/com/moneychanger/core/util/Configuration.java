...
public class Configuration {
    ...
    public static String getImagePath() {
        return ConfigBean.Static.getKey(ConfigBean.Static.Keys.PasswordImagePath);
    }

    public static void setImagePath(String imagePath) {
        ConfigBean.Static.setKey(ConfigBean.Static.Keys.PasswordImagePath, imagePath);
    }

    public static String getLoomPasswordID() {
        return ConfigBean.Static.getKey(ConfigBean.Static.Keys.LoomPasswordID);
    }

    public static void setLoomPasswordID(String loomPasswordID) {
        ConfigBean.Static.setKey(ConfigBean.Static.Keys.LoomPasswordID, loomPasswordID);
    }

    public static String getMarketMaxDepth() {
        return ConfigBean.Static.getKey(ConfigBean.Static.Keys.MarketMaxDepth);
    }

    public static void setMarketMaxDepth(String marketMaxDepth) {
        ConfigBean.Static.setKey(ConfigBean.Static.Keys.MarketMaxDepth, marketMaxDepth);
    }

    public static String getRipplePasswordID() {
        return ConfigBean.Static.getKey(ConfigBean.Static.Keys.RipplePasswordID);
    }

    public static void setRipplePasswordID(String ripplePasswordID) {
        ConfigBean.Static.setKey(ConfigBean.Static.Keys.RipplePasswordID, ripplePasswordID);
    }

    public static String getRippleUsernameID() {
        return ConfigBean.Static.getKey(ConfigBean.Static.Keys.RippleUsernameID);
    }

    public static void setRippleUsernameID(String rippleUsernameID) {
        ConfigBean.Static.setKey(ConfigBean.Static.Keys.RippleUsernameID, rippleUsernameID);
    }

    public static int getNbrTransactionCount() {
        return ConfigBean.Static.getKeyAsInteger(ConfigBean.Static.Keys.NbrTransactionCount);
    }

    public static void setNbrTransactionCount(int nbrTransactionCount) {
        ConfigBean.Static.setGenericKey(ConfigBean.Static.Keys.NbrTransactionCount, nbrTransactionCount);
    }

    public static int getRetryCount() {
        return ConfigBean.Static.getKeyAsInteger(ConfigBean.Static.Keys.RetryCount);
    }

    public static void setRetryCount(int retryCount) {
        ConfigBean.Static.setGenericKey(ConfigBean.Static.Keys.RetryCount, retryCount);
    }

    public static long getWaitTime() {
        return ConfigBean.Static.getKeyAsLong(ConfigBean.Static.Keys.WaitTime);
    }

    public static void setWaitTime(long waitTime) {
        ConfigBean.Static.setGenericKey(ConfigBean.Static.Keys.WaitTime, waitTime);
    }
}
