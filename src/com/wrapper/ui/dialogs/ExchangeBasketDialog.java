...
public class ExchangeBasketDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(ExchangeBasketDialog.class);
    ...
    private void doExchangeBasket() throws InterruptedException {
        ...
        if (!bTrue || otapi.OT_API_GetNym_TransactionNumCount(serverID, nymID) < (2+memberCount)) {
